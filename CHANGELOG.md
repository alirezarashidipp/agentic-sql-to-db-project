...
- Fixed the application table name as `data`, kept `DATABASE_PATH` configurable,
  and renamed the sample asset to `main_datawarehouse.db`.
...
- Automatically render a Bar chart for compatible results and offer Pie when
  valid, without a chart dependency.
